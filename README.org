...
| Ctrl-X      | Swap panes                |
| Ctrl-O      | Toggle nick list panel    |
| F10         | Quit                      |

** Theming

CLatter supports custom themes loaded from =~/.config/clatter/themes/=. The default theme is Tokyo Night with purple/magenta borders and rounded corners.

*** Creating a Custom Theme

Create a file in =~/.config/clatter/themes/= (e.g., =my-theme.lisp=):

#+begin_src lisp
;;; CLatter Theme: my-theme
;;; Place in ~/.config/clatter/themes/my-theme.lisp
...
Standard ncurses colors: =:black=, =:red=, =:green=, =:yellow=, =:blue=, =:magenta=, =:cyan=, =:white=

*** Theme Properties

| Property              | Description                                    |
|-----------------------+------------------------------------------------|
| =:nick-colors=        | List of colors for nick colorization           |
| =:join-color=         | Color for join messages                        |
| =:part-color=         | Color for part messages                        |
| =:quit-color=         | Color for quit messages                        |
| =:kick-color=         | Color for kick messages                        |
| =:mode-color=         | Color for mode change messages                 |
| =:topic-color=        | Color for topic messages                       |
| =:notice-color=       | Color for notice messages                      |
| =:system-color=       | Color for system messages                      |
| =:error-color=        | Color for error messages                       |
| =:highlight-fg=       | Foreground color for highlighted messages      |
| =:highlight-bold=     | Whether highlights are bold (=t= or =nil=)     |
| =:border-fg=          | Color for window borders                       |
| =:buflist-fg=         | Buffer list text color                         |
| =:buflist-selected-fg=| Selected buffer color                          |
| =:buflist-unread-fg=  | Unread buffer color                            |
